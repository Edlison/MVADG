...
def lbp_on_mnist():
    ...
    tar_f = '../../data/mnist_custom/processed/mnist_lbp.pt'
...
def lbp_on_fashionmnist():
    ...
    # save
    file = (lbp_imgs, labels)
    tar_f = '../../data/FashionMNIST/processed/fashionmnist_lbp.pt'
    with open(tar_f, 'wb') as f:
        torch.save(file, f)
    print('shape ', lbp_imgs.shape)
    print('lbp on fashionmnist generate success.')
