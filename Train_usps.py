...
from clusgan.models import Generator_CNN, Encoder_CNN, Discriminator_CNN, MultiNet_usps
...
def main():
    ...
    net = MultiNet_usps(view_num=2, latent_dim=latent_dim, cls_num=n_c, x_shape=x_shape2, wass=True)
